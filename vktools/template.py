import json
from typing_extensions import List, Dict, Any, Union, Optional
from .keyboard import Text, OpenLink, Location, VkApps, VkPay
...
class Element:
  def __new__(
    ...
    buttons: Optional[List[Union[Text,OpenLink,Location,VkPay,VkApps]]] | None=None, 
